...
$title = ($ost && ($title=$ost->getPageTitle()))
    ? $title : ('Highpot Tech :: '.__('Staff Control Panel'));
...
if (osTicket::is_ie())
    $ost->setWarning(__('Highpot Tech no longer supports Internet Explorer.'));
?>>
<head>
...
<?php } else {
    ...
    <title><?php echo ($ost && ($title=$ost->getPageTitle()))?$title:'Highpot Tech :: '.__('Staff Control Panel'); ?></title><?php
} # endif X_PJAX ?>
    <ul id="nav">
