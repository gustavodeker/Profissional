...
define('SECRET_SALT','Eo6TivwQvXu6f71R5ezPkbgV8eHqtO5N');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','gustavobruno.contato@ymail.com');
...
define('DBNAME','u273458796_suporte');
define('DBUSER','u273458796_suporte');
define('DBPASS','@8038375Gg?');
